...
class Duration private constructor(
    ...
    fun copy(dsl: DurationDsl.() -> Unit): Duration = Duration {
    ...
    companion object Deserializer : AbstractKtDeserializer<Duration>() {
...
fun Duration(dsl: Duration.DurationDsl.() -> Unit): Duration =
        Duration.DurationDsl().apply(dsl).build()

...
class Timestamp private constructor(
    ...
    fun copy(dsl: TimestampDsl.() -> Unit): Timestamp = Timestamp {
    ...
    companion object Deserializer : AbstractKtDeserializer<Timestamp>() {
...
fun Timestamp(dsl: Timestamp.TimestampDsl.() -> Unit): Timestamp =
        Timestamp.TimestampDsl().apply(dsl).build()

...
class DoubleValue private constructor(
    ...
    fun copy(dsl: DoubleValueDsl.() -> Unit): DoubleValue = DoubleValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<DoubleValue>() {
...
class FloatValue private constructor(
    ...
    fun copy(dsl: FloatValueDsl.() -> Unit): FloatValue = FloatValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<FloatValue>() {
...
class Int64Value private constructor(
    ...
    fun copy(dsl: Int64ValueDsl.() -> Unit): Int64Value = Int64Value {
    ...
    companion object Deserializer : AbstractKtDeserializer<Int64Value>() {
...
class UInt64Value private constructor(
    ...
    fun copy(dsl: UInt64ValueDsl.() -> Unit): UInt64Value = UInt64Value {
    ...
    companion object Deserializer : AbstractKtDeserializer<UInt64Value>() {
...
class Int32Value private constructor(
    ...
    fun copy(dsl: Int32ValueDsl.() -> Unit): Int32Value = Int32Value {
    ...
    companion object Deserializer : AbstractKtDeserializer<Int32Value>() {
...
class UInt32Value private constructor(
    ...
    fun copy(dsl: UInt32ValueDsl.() -> Unit): UInt32Value = UInt32Value {
    ...
    companion object Deserializer : AbstractKtDeserializer<UInt32Value>() {
...
class BoolValue private constructor(
    ...
    fun copy(dsl: BoolValueDsl.() -> Unit): BoolValue = BoolValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<BoolValue>() {
...
class StringValue private constructor(
    ...
    fun copy(dsl: StringValueDsl.() -> Unit): StringValue = StringValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<StringValue>() {
...
class BytesValue private constructor(
    ...
    fun copy(dsl: BytesValueDsl.() -> Unit): BytesValue = BytesValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<BytesValue>() {
...
fun DoubleValue(dsl: DoubleValue.DoubleValueDsl.() -> Unit): DoubleValue =
        DoubleValue.DoubleValueDsl().apply(dsl).build()

fun FloatValue(dsl: FloatValue.FloatValueDsl.() -> Unit): FloatValue =
        FloatValue.FloatValueDsl().apply(dsl).build()

fun Int64Value(dsl: Int64Value.Int64ValueDsl.() -> Unit): Int64Value =
        Int64Value.Int64ValueDsl().apply(dsl).build()

fun UInt64Value(dsl: UInt64Value.UInt64ValueDsl.() -> Unit): UInt64Value =
        UInt64Value.UInt64ValueDsl().apply(dsl).build()

fun Int32Value(dsl: Int32Value.Int32ValueDsl.() -> Unit): Int32Value =
        Int32Value.Int32ValueDsl().apply(dsl).build()

fun UInt32Value(dsl: UInt32Value.UInt32ValueDsl.() -> Unit): UInt32Value =
        UInt32Value.UInt32ValueDsl().apply(dsl).build()

fun BoolValue(dsl: BoolValue.BoolValueDsl.() -> Unit): BoolValue =
        BoolValue.BoolValueDsl().apply(dsl).build()

fun StringValue(dsl: StringValue.StringValueDsl.() -> Unit): StringValue =
        StringValue.StringValueDsl().apply(dsl).build()

fun BytesValue(dsl: BytesValue.BytesValueDsl.() -> Unit): BytesValue =
        BytesValue.BytesValueDsl().apply(dsl).build()

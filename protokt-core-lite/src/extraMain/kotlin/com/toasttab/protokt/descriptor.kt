...
class FileDescriptorSet private constructor(
    ...
    fun copy(dsl: FileDescriptorSetDsl.() -> Unit): FileDescriptorSet = FileDescriptorSet {
    ...
    companion object Deserializer : AbstractKtDeserializer<FileDescriptorSet>() {
...
class FileDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<FileDescriptorProto>() {
...
class DescriptorProto private constructor(
    ...
    fun copy(dsl: DescriptorProtoDsl.() -> Unit): DescriptorProto = DescriptorProto {
    ...
    companion object Deserializer : AbstractKtDeserializer<DescriptorProto>() {
        ...
        fun ExtensionRange(dsl: ExtensionRange.ExtensionRangeDsl.() -> Unit): ExtensionRange
                = ExtensionRange.ExtensionRangeDsl().apply(dsl).build()

        fun ReservedRange(dsl: ReservedRange.ReservedRangeDsl.() -> Unit): ReservedRange =
                ReservedRange.ReservedRangeDsl().apply(dsl).build()
    }
    ...
    class ExtensionRange private constructor(
        ...
        fun copy(dsl: ExtensionRangeDsl.() -> Unit): ExtensionRange = ExtensionRange {
        ...
        companion object Deserializer : AbstractKtDeserializer<ExtensionRange>() {
    ...
    class ReservedRange private constructor(
        ...
        fun copy(dsl: ReservedRangeDsl.() -> Unit): ReservedRange = ReservedRange {
        ...
        companion object Deserializer : AbstractKtDeserializer<ReservedRange>() {
...
class ExtensionRangeOptions private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<ExtensionRangeOptions>() {
...
class FieldDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<FieldDescriptorProto>() {
...
class OneofDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<OneofDescriptorProto>() {
...
class EnumDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<EnumDescriptorProto>() {
        ...
        fun EnumReservedRange(dsl: EnumReservedRange.EnumReservedRangeDsl.() -> Unit):
                EnumReservedRange = EnumReservedRange.EnumReservedRangeDsl().apply(dsl).build()
    }
    ...
    class EnumReservedRange private constructor(
        ...
        companion object Deserializer : AbstractKtDeserializer<EnumReservedRange>() {
            override fun deserialize(deserializer: KtMessageDeserializer):
                    EnumReservedRange {
                var start : Int? = null
                var end : Int? = null
...
class EnumValueDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<EnumValueDescriptorProto>() {
        override fun deserialize(deserializer: KtMessageDeserializer):
                EnumValueDescriptorProto {
            var name : String? = null
            var number : Int? = null
...
class ServiceDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<ServiceDescriptorProto>() {
        override fun deserialize(deserializer: KtMessageDeserializer):
                ServiceDescriptorProto {
            var name : String? = null
...
class MethodDescriptorProto private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<MethodDescriptorProto>() {
        override fun deserialize(deserializer: KtMessageDeserializer):
                MethodDescriptorProto {
            var name : String? = null
            var inputType : String? = null
...
class FileOptions private constructor(
    ...
    fun copy(dsl: FileOptionsDsl.() -> Unit): FileOptions = FileOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<FileOptions>() {
...
class MessageOptions private constructor(
    ...
    fun copy(dsl: MessageOptionsDsl.() -> Unit): MessageOptions = MessageOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<MessageOptions>() {
...
class FieldOptions private constructor(
    ...
    fun copy(dsl: FieldOptionsDsl.() -> Unit): FieldOptions = FieldOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<FieldOptions>() {
...
class OneofOptions private constructor(
    ...
    fun copy(dsl: OneofOptionsDsl.() -> Unit): OneofOptions = OneofOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<OneofOptions>() {
...
class EnumOptions private constructor(
    ...
    fun copy(dsl: EnumOptionsDsl.() -> Unit): EnumOptions = EnumOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<EnumOptions>() {
...
class EnumValueOptions private constructor(
    ...
    fun copy(dsl: EnumValueOptionsDsl.() -> Unit): EnumValueOptions = EnumValueOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<EnumValueOptions>() {
...
class ServiceOptions private constructor(
    ...
    fun copy(dsl: ServiceOptionsDsl.() -> Unit): ServiceOptions = ServiceOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<ServiceOptions>() {
...
class MethodOptions private constructor(
    ...
    fun copy(dsl: MethodOptionsDsl.() -> Unit): MethodOptions = MethodOptions {
    ...
    companion object Deserializer : AbstractKtDeserializer<MethodOptions>() {
...
class UninterpretedOption private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<UninterpretedOption>() {
        ...
        fun NamePart(dsl: NamePart.NamePartDsl.() -> Unit): NamePart =
                NamePart.NamePartDsl().apply(dsl).build()
    }
     ...
     * options specs in .proto files). E.g.,{ ["foo", false], ["bar.baz", true], ["qux", false] }
    ...
    class NamePart private constructor(
        ...
        fun copy(dsl: NamePartDsl.() -> Unit): NamePart = NamePart {
        ...
        companion object Deserializer : AbstractKtDeserializer<NamePart>() {
...
class SourceCodeInfo private constructor(
    ...
    fun copy(dsl: SourceCodeInfoDsl.() -> Unit): SourceCodeInfo = SourceCodeInfo {
    ...
    companion object Deserializer : AbstractKtDeserializer<SourceCodeInfo>() {
        ...
        fun Location(dsl: Location.LocationDsl.() -> Unit): Location =
                Location.LocationDsl().apply(dsl).build()
    }
    ...
    class Location private constructor(
         ...
         * baz. 
         *
         *    // Comment attached to qux.   //   // Another line attached to qux.   optional double
         * qux = 4; 
         *
         *    // Detached comment for corge. This is not leading or trailing comments   // to qux or
        ...
        fun copy(dsl: LocationDsl.() -> Unit): Location = Location {
        ...
        companion object Deserializer : AbstractKtDeserializer<Location>() {
...
class GeneratedCodeInfo private constructor(
    ...
    fun copy(dsl: GeneratedCodeInfoDsl.() -> Unit): GeneratedCodeInfo = GeneratedCodeInfo {
    ...
    companion object Deserializer : AbstractKtDeserializer<GeneratedCodeInfo>() {
        ...
        fun Annotation(dsl: Annotation.AnnotationDsl.() -> Unit): Annotation =
                Annotation.AnnotationDsl().apply(dsl).build()
    }
    ...
    class Annotation private constructor(
        ...
        fun copy(dsl: AnnotationDsl.() -> Unit): Annotation = Annotation {
        ...
        companion object Deserializer : AbstractKtDeserializer<Annotation>() {
...
fun FileDescriptorSet(dsl: FileDescriptorSet.FileDescriptorSetDsl.() -> Unit):
        FileDescriptorSet = FileDescriptorSet.FileDescriptorSetDsl().apply(dsl).build()

fun FileDescriptorProto(dsl: FileDescriptorProto.FileDescriptorProtoDsl.() -> Unit):
        FileDescriptorProto = FileDescriptorProto.FileDescriptorProtoDsl().apply(dsl).build()

fun DescriptorProto(dsl: DescriptorProto.DescriptorProtoDsl.() -> Unit): DescriptorProto =
        DescriptorProto.DescriptorProtoDsl().apply(dsl).build()

fun ExtensionRangeOptions(dsl: ExtensionRangeOptions.ExtensionRangeOptionsDsl.() -> Unit):
        ExtensionRangeOptions = ExtensionRangeOptions.ExtensionRangeOptionsDsl().apply(dsl).build()

fun FieldDescriptorProto(dsl: FieldDescriptorProto.FieldDescriptorProtoDsl.() -> Unit):
        FieldDescriptorProto = FieldDescriptorProto.FieldDescriptorProtoDsl().apply(dsl).build()

fun OneofDescriptorProto(dsl: OneofDescriptorProto.OneofDescriptorProtoDsl.() -> Unit):
        OneofDescriptorProto = OneofDescriptorProto.OneofDescriptorProtoDsl().apply(dsl).build()

fun EnumDescriptorProto(dsl: EnumDescriptorProto.EnumDescriptorProtoDsl.() -> Unit):
        EnumDescriptorProto = EnumDescriptorProto.EnumDescriptorProtoDsl().apply(dsl).build()

fun EnumValueDescriptorProto(dsl: EnumValueDescriptorProto.EnumValueDescriptorProtoDsl.() ->
        Unit): EnumValueDescriptorProto =
        EnumValueDescriptorProto.EnumValueDescriptorProtoDsl().apply(dsl).build()

fun ServiceDescriptorProto(dsl: ServiceDescriptorProto.ServiceDescriptorProtoDsl.() -> Unit):
        ServiceDescriptorProto =
        ServiceDescriptorProto.ServiceDescriptorProtoDsl().apply(dsl).build()

fun MethodDescriptorProto(dsl: MethodDescriptorProto.MethodDescriptorProtoDsl.() -> Unit):
        MethodDescriptorProto = MethodDescriptorProto.MethodDescriptorProtoDsl().apply(dsl).build()

fun FileOptions(dsl: FileOptions.FileOptionsDsl.() -> Unit): FileOptions =
        FileOptions.FileOptionsDsl().apply(dsl).build()

fun MessageOptions(dsl: MessageOptions.MessageOptionsDsl.() -> Unit): MessageOptions =
        MessageOptions.MessageOptionsDsl().apply(dsl).build()

fun FieldOptions(dsl: FieldOptions.FieldOptionsDsl.() -> Unit): FieldOptions =
        FieldOptions.FieldOptionsDsl().apply(dsl).build()

fun OneofOptions(dsl: OneofOptions.OneofOptionsDsl.() -> Unit): OneofOptions =
        OneofOptions.OneofOptionsDsl().apply(dsl).build()

fun EnumOptions(dsl: EnumOptions.EnumOptionsDsl.() -> Unit): EnumOptions =
        EnumOptions.EnumOptionsDsl().apply(dsl).build()

fun EnumValueOptions(dsl: EnumValueOptions.EnumValueOptionsDsl.() -> Unit): EnumValueOptions
        = EnumValueOptions.EnumValueOptionsDsl().apply(dsl).build()

fun ServiceOptions(dsl: ServiceOptions.ServiceOptionsDsl.() -> Unit): ServiceOptions =
        ServiceOptions.ServiceOptionsDsl().apply(dsl).build()

fun MethodOptions(dsl: MethodOptions.MethodOptionsDsl.() -> Unit): MethodOptions =
        MethodOptions.MethodOptionsDsl().apply(dsl).build()

fun UninterpretedOption(dsl: UninterpretedOption.UninterpretedOptionDsl.() -> Unit):
        UninterpretedOption = UninterpretedOption.UninterpretedOptionDsl().apply(dsl).build()

fun SourceCodeInfo(dsl: SourceCodeInfo.SourceCodeInfoDsl.() -> Unit): SourceCodeInfo =
        SourceCodeInfo.SourceCodeInfoDsl().apply(dsl).build()

fun GeneratedCodeInfo(dsl: GeneratedCodeInfo.GeneratedCodeInfoDsl.() -> Unit):
        GeneratedCodeInfo = GeneratedCodeInfo.GeneratedCodeInfoDsl().apply(dsl).build()

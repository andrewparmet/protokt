...
class Empty private constructor(
    ...
    override fun toString(): String = "Empty(unknownFields=$unknownFields)"

    fun copy(dsl: EmptyDsl.() -> Unit): Empty = Empty {
    ...
    companion object Deserializer : AbstractKtDeserializer<Empty>() {
...
fun Empty(dsl: Empty.EmptyDsl.() -> Unit): Empty = Empty.EmptyDsl().apply(dsl).build()

...
class Version private constructor(
    ...
    fun copy(dsl: VersionDsl.() -> Unit): Version = Version {
    ...
    companion object Deserializer : AbstractKtDeserializer<Version>() {
...
class CodeGeneratorRequest private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<CodeGeneratorRequest>() {
...
class CodeGeneratorResponse private constructor(
    ...
    companion object Deserializer : AbstractKtDeserializer<CodeGeneratorResponse>() {
        ...
        fun File(dsl: File.FileDsl.() -> Unit): File = File.FileDsl().apply(dsl).build()
    }
    ...
    class File private constructor(
        ...
        fun copy(dsl: FileDsl.() -> Unit): File = File {
            name = this@File.name
        ...
        companion object Deserializer : AbstractKtDeserializer<File>() {
...
fun Version(dsl: Version.VersionDsl.() -> Unit): Version =
        Version.VersionDsl().apply(dsl).build()

fun CodeGeneratorRequest(dsl: CodeGeneratorRequest.CodeGeneratorRequestDsl.() -> Unit):
        CodeGeneratorRequest = CodeGeneratorRequest.CodeGeneratorRequestDsl().apply(dsl).build()

fun CodeGeneratorResponse(dsl: CodeGeneratorResponse.CodeGeneratorResponseDsl.() -> Unit):
        CodeGeneratorResponse = CodeGeneratorResponse.CodeGeneratorResponseDsl().apply(dsl).build()

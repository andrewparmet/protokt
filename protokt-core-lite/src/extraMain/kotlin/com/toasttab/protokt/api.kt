...
class Api private constructor(
    ...
    fun copy(dsl: ApiDsl.() -> Unit): Api = Api {
        name = this@Api.name
    ...
    companion object Deserializer : AbstractKtDeserializer<Api>() {
...
class Method private constructor(
    ...
    fun copy(dsl: MethodDsl.() -> Unit): Method = Method {
    ...
    companion object Deserializer : AbstractKtDeserializer<Method>() {
...
class Mixin private constructor(
    ...
    fun copy(dsl: MixinDsl.() -> Unit): Mixin = Mixin {
    ...
    companion object Deserializer : AbstractKtDeserializer<Mixin>() {
...
fun Api(dsl: Api.ApiDsl.() -> Unit): Api = Api.ApiDsl().apply(dsl).build()

fun Method(dsl: Method.MethodDsl.() -> Unit): Method = Method.MethodDsl().apply(dsl).build()

fun Mixin(dsl: Mixin.MixinDsl.() -> Unit): Mixin = Mixin.MixinDsl().apply(dsl).build()

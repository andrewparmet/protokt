...
class Type private constructor(
    ...
    fun copy(dsl: TypeDsl.() -> Unit): Type = Type {
        name = this@Type.name
    ...
    companion object Deserializer : AbstractKtDeserializer<Type>() {
...
class Field private constructor(
    ...
    fun copy(dsl: FieldDsl.() -> Unit): Field = Field {
    ...
    companion object Deserializer : AbstractKtDeserializer<Field>() {
...
class Enum_ private constructor(
    ...
    fun copy(dsl: Enum_Dsl.() -> Unit): Enum_ = Enum_ {
    ...
    companion object Deserializer : AbstractKtDeserializer<Enum_>() {
...
class EnumValue private constructor(
    ...
    fun copy(dsl: EnumValueDsl.() -> Unit): EnumValue = EnumValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<EnumValue>() {
...
class Option private constructor(
    ...
    fun copy(dsl: OptionDsl.() -> Unit): Option = Option {
    ...
    companion object Deserializer : AbstractKtDeserializer<Option>() {
...
fun Type(dsl: Type.TypeDsl.() -> Unit): Type = Type.TypeDsl().apply(dsl).build()

fun Field(dsl: Field.FieldDsl.() -> Unit): Field = Field.FieldDsl().apply(dsl).build()

fun Enum_(dsl: Enum_.Enum_Dsl.() -> Unit): Enum_ = Enum_.Enum_Dsl().apply(dsl).build()

fun EnumValue(dsl: EnumValue.EnumValueDsl.() -> Unit): EnumValue =
        EnumValue.EnumValueDsl().apply(dsl).build()

fun Option(dsl: Option.OptionDsl.() -> Unit): Option = Option.OptionDsl().apply(dsl).build()

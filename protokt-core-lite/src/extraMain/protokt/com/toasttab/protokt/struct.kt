...
class Struct private constructor(
    ...
    fun copy(dsl: StructDsl.() -> Unit): Struct = Struct {
    ...
    companion object Deserializer : AbstractKtDeserializer<Struct>() {
    ...
    private class FieldsEntry(
        ...
        companion object Deserializer : AbstractKtDeserializer<FieldsEntry>() {
            ...
            override fun deserialize(deserializer: KtMessageDeserializer): FieldsEntry {
                ...
                while (true) {
                  when (deserializer.readTag()) {
                    0 -> return FieldsEntry(key, value ?: Value.ValueDsl().build())
...
class Value private constructor(
    ...
    fun copy(dsl: ValueDsl.() -> Unit): Value = Value {
    ...
    companion object Deserializer : AbstractKtDeserializer<Value>() {
...
class ListValue private constructor(
    ...
    fun copy(dsl: ListValueDsl.() -> Unit): ListValue = ListValue {
    ...
    companion object Deserializer : AbstractKtDeserializer<ListValue>() {
...
fun Struct(dsl: Struct.StructDsl.() -> Unit): Struct = Struct.StructDsl().apply(dsl).build()

fun Value(dsl: Value.ValueDsl.() -> Unit): Value = Value.ValueDsl().apply(dsl).build()

fun ListValue(dsl: ListValue.ListValueDsl.() -> Unit): ListValue =
        ListValue.ListValueDsl().apply(dsl).build()

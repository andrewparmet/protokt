...
class UnknownFieldSet private constructor(
    ...
    private constructor(
        ...
        fun write(fieldNumber: UInt, serializer: MessageSerializer) {
            asSequence().forEach { serializer.write(it, fieldNumber) }
        }

        private fun MessageSerializer.write(
        ...
        private fun MessageSerializer.write(fieldNumber: UInt, wireType: Int) =
